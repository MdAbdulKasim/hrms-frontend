...
export default function EProfileForm({
    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                            <div>
                                ...
                                <p className="text-sm text-gray-600 mt-1">
                                    Manage your official documents and identity numbers.
                                </p>
                            </div>
            ...
            {/* Additional Information Section (Under Personal Part 2) */}
            {(activeSection === 'personal') && (
                <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                    <Card className="p-6 border-none shadow-sm bg-white">
                        <h2 className="text-xl font-bold mb-6 flex items-center gap-2 text-gray-900 border-b border-gray-50 pb-4">
                        ...
                        <h3 className="text-lg font-bold text-gray-900 mt-8 mb-4 border-t border-gray-50 pt-6 flex items-center gap-2">
                            <Activity size={18} className="text-blue-600" />
                            Emergency Contact
                        </h3>
            ...
            <div className="flex justify-center mt-8 pb-8">
                <Button
                    onClick={handleSave}
                    disabled={!isEditing}
                    className="w-full sm:w-auto px-12 py-6 text-lg bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-lg shadow-lg flex items-center gap-2 group transition-all"
                >
                    <Lock size={20} className={!isEditing ? "text-white/50" : "text-white"} />
                    Save Changes
                </Button>
            </div>
        </div>
