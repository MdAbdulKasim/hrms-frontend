"use client"
  ...
  export default function TimeTrackingPage() {
    ...
    // Fix: Add type annotations for the callback functions
    ...
    return (
      <div className="min-h-screen bg-gray-50 p-4 sm:p-6 lg:p-8">
                ...
                <div className="relative" ref={timerProjectDropdownRef}>
                  <div className="flex items-center gap-2 px-4 py-2.5 border border-gray-300 rounded-lg bg-white cursor-pointer hover:border-gray-400 transition-colors">
                    ...
                    <ChevronDown
                      ...
                      onClick={() => setShowTimerProjectDropdown(!showTimerProjectDropdown)}
                    />
                  </div>
                    ...
                    <div className="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-60 overflow-y-auto">
                      <div className="p-2">
                        <input
                          ...
                          onKeyPress={(e) => {
                            if (e.key === "Enter") {
                              handleCreateTimerProject()
                            }
                          }}
                        />
                        {newTimerProjectInput.trim() && (
                          <button
                            onClick={handleCreateTimerProject}
                ...
                <div className="flex gap-3 justify-center">
                  <button
                    ...
                    className={`flex-1 sm:flex-none justify-center flex items-center gap-2 px-6 py-2.5 rounded-lg transition-colors ${
                      isTimerRunning || !isTimerFormComplete
              ...
              <div className="relative" ref={timerTaskDropdownRef}>
                <div className="flex items-center gap-2 px-4 py-2.5 border border-gray-300 rounded-lg bg-white cursor-pointer hover:border-gray-400 transition-colors">
                  ...
                  <ChevronDown
                    size={20}
                    className="text-gray-400 cursor-pointer"
                    onClick={() => setShowTimerTaskDropdown(!showTimerTaskDropdown)}
                  />
                </div>
                ...
                {showTimerTaskDropdown && (
                  <div className="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-60 overflow-y-auto">
                    <div className="p-2">
                      <input
                        type="text"
                        value={newTimerTaskInput}
                        onChange={(e) => setNewTimerTaskInput(e.target.value)}
                        placeholder="Type to create new..."
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                        onKeyPress={(e) => {
                          if (e.key === "Enter") {
                            handleCreateTimerTask()
                          }
                        }}
                      />
                      {newTimerTaskInput.trim() && (
                        <button
                          onClick={handleCreateTimerTask}
                          className="w-full mt-2 px-3 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm font-medium flex items-center justify-center gap-2"
                        >
                          <Plus size={16} />
                          Create "{newTimerTaskInput}"
                        </button>
                      )}
                    </div>
                    <div className="border-t border-gray-200">
              ...
              <div className="relative" ref={timerStatusDropdownRef}>
                <div className="flex items-center gap-2 px-4 py-2.5 border border-gray-300 rounded-lg bg-white cursor-pointer hover:border-gray-400 transition-colors">
                  ...
                  <ChevronDown
                    size={20}
                    className="text-gray-400 cursor-pointer"
                    onClick={() => setShowTimerStatusDropdown(!showTimerStatusDropdown)}
                  />
                </div>
                ...
                {showTimerStatusDropdown && (
                  <div className="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-60 overflow-y-auto">
                    <div className="p-2">
                      <input
                        type="text"
                        value={newTimerStatusInput}
                        onChange={(e) => setNewTimerStatusInput(e.target.value)}
                        placeholder="Type to create new..."
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                        onKeyPress={(e) => {
                          if (e.key === "Enter") {
                            handleCreateTimerStatus()
                          }
                        }}
                      />
                      {newTimerStatusInput.trim() && (
                        <button
                          onClick={handleCreateTimerStatus}
                          className="w-full mt-2 px-3 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm font-medium flex items-center justify-center gap-2"
                        >
                          <Plus size={16} />
                          Create "{newTimerStatusInput}"
                        </button>
                      )}
                    </div>
                    <div className="border-t border-gray-200">
                  ...
                  {entries.map((entry, index) => (
                    <tr key={index} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <span
                          className={`inline-flex px-3 py-1 text-xs font-medium rounded-full ${getStatusColor(entry.status)}`}
                        >
                          {entry.status}
                        </span>
                      </td>
        ...
        {/* Fix: Updated TimeEntryDialog props */}
        <TimeEntryDialog
  open={isDialogOpen}
  ...
  onCreateStatus={(name: string) => setStatuses([...statuses, name])}
/>
