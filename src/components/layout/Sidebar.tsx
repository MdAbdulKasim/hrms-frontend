    ...
    <>
      <aside 
        className={`
          ...
          fixed inset-y-0 left-0 h-dvh w-[280px] max-w-[85vw] shadow-3xl
      ...
      >
        ...
        <div className={`px-3 pb-3 border-t border-slate-100 ${isDesktopCollapsed ? "lg:px-0 lg:flex lg:justify-center" : ""}`}>
          <button
            ...
            className={`
              w-full flex items-center gap-3 px-4 py-2.5 text-sm font-medium text-red-600 
              hover:bg-red-50 rounded-lg transition-all duration-200
              ${isDesktopCollapsed ? "lg:w-auto lg:justify-center lg:px-3" : ""}
            `}
